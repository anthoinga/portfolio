      ...
      <div className="flex">
        <div className="w-full max-w-[424px] overflow-hidden">
          {tracks.map((track) => (
            <div
              key={track.id}
              className="track flex items-center py-px w-full"
            >
              <div className="track-number w-[39px] shrink-0 flex items-center justify-center">
                <span className="font-body text-[14px] text-[#adacb1] tracking-[1px]">
                  {track.id}
                </span>
              </div>
              <div className="track-title flex-1 min-w-0 py-[6px]">
                <p className="font-body text-[14px] text-white truncate overflow-hidden">
                  {track.title}
                </p>
              </div>
              <div className="track-duration shrink-0 pl-2 pr-4 py-[6px]">
