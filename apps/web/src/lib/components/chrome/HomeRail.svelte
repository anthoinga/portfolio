<script lang="ts">
	...
	import type { Credit, SiteSettings } from '$lib/sanity/types'
...
<aside
	class="home-rail lg:col-span-2 transition-opacity duration-700 ease-[var(--ease)]"
	class:opacity-0={faded}
	class:pointer-events-none={faded}
	aria-hidden={faded}
	bind:clientHeight={homeRail.height}
>
